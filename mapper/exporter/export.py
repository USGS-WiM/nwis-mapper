...
class root:
	...
	#                                      C=data codes, 1=all,    2=iv,      3=dv, 4=qw, 5=pk, 6=sv, 7=ad, 8=gw
	#
	#     File format:  fformat=1=html, 2=txt, 3=Excel, 4=csv, 5=rdb, 6=kml, 7=shp

	def exportFile(self, bbox="", scodes="", fformat=""):
		#define global var for fformat for log file
		#couldn't figure out how to make incoming variable a global
		global globalfformat
		globalfformat = fformat
